...
?>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npn/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
...
<div class="containder mt-5">
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            ?>
            <div class="alert-danger alert-dismissible dafe show" role="alert">
            <strong>Error!</strong> Rellena todos los campos.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label aria_label="Close"></button>
            </div>
            <?php        
                }
            ?>
